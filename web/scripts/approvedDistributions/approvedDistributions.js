...
function printReport(){
	window.open('hotSheet?action=printItemAllowance&startDate=' + $('startDate').value + "&endDate=" + $('endDate').value + "&number=" + $('number').value + "&type=" + $('type').value, "Item Allowance Report");
}

function exportReport(){
	window.open('hotSheet?action=exportItemAllowance&startDate=' + $('startDate').value + "&endDate=" + $('endDate').value + "&number=" + $('number').value + "&type=" + $('type').value, "Item Allowance Report");
}